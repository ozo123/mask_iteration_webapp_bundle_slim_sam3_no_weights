...
class Sam3TrackerPredictor(Sam3TrackerBase):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Keep interactive tracking in stable fp32 mode for local image workflows.
        # The global bf16 autocast can leak into the main SAM3 image backbone path
        # and cause dtype mismatches such as "BFloat16 and Float" on some setups.
